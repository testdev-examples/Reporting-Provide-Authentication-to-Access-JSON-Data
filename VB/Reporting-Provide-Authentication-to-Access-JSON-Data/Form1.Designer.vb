...
'ORIGINAL LINE: this.button2.Click += new System.EventHandler(this.RuntimeAuthenticationButton_Click);
			...
			Me.label1.Text = "Example1:" & vbCrLf & "Show the Report Designer with a customized Specify JSON Data Location " & "wizard page. Specify the user name and password to connect to the Web Service En" & "dpoint(URI) on this page." & vbCrLf
			' 
			' label2
			' 
			...
			Me.label2.Text = "Example2:" & vbCrLf & "Show the Report Designer to display a report that is bound to a custom" & " JsonDataSource with the specified user name and password."
			' 
			' Form1
			' 
